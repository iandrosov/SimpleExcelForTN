package SimpleExcelForTN;

// -----( IS Java Code Template v1.2
// -----( CREATED: 2005-08-31 11:54:12 JST
	...
	private static final long   DAY_MILLISECONDS  = 24 * 60 * 60 * 1000;
	    ...
	    protected static Properties getProps()
	    {
	        if(_props == null)
	            try
	            {
	                File cfgfn = new File(Server.getResources().getPackageConfigDir("SimpleExcelForTN"), "excel.cnf");
	                if(cfgfn.exists())
	                {
